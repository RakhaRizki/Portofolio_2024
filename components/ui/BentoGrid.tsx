...
export const BentoGridItem = ({
  ...
  const handlecopy = () => {
    navigator.clipboard.writeText('Babanrakha@gmail.com')
  ...
  return (
    ...
    >
       <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        <div className={cn(
          titleClassName, 'group-hover bento:translate-x-2 transition duration-200 relative md:max-h-full min-h-40 flex flex-col px-5 p-5 lg:p-10'
        )}>
